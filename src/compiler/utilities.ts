...
namespace ts {
    ...
    export const supportedJSExtensions: readonly Extension[] = [Extension.Mjs, Extension.Js, Extension.Jsx];
    export const supportedJSAndJsonExtensions: readonly Extension[] = [Extension.Mjs, Extension.Js, Extension.Jsx, Extension.Json];
